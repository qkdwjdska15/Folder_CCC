...
private Tab subject;
@FXML
private SubjectTabController subjectTabController;//참조변수명 부여 방법 :include 시 명시한id+"Controller"
@FXML
private Tab student;
@FXML
...
private MenuItem menuInfo;
	...
	public void handlerMenuInfoAction(ActionEvent event) {
		...
		alert.setContentText("Future Universit Register Courses Vesion 0.01");
